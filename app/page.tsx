            ...
            <section id="community" className="py-20 bg-background relative noise-overlay">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            { data: t.community.strava, href: "https://www.strava.com/clubs/sunday-cycling-club", color: "from-orange-500 to-orange-600", icon: <path d="M15.387 17.944l-2.089-4.116h-3.065L15.387 24l5.15-10.172h-3.066m-7.008-5.599l2.836 5.598h4.172L10.463 0l-7 13.828h4.169"/> },
